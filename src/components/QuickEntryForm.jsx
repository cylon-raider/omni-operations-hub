  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
      <h3 className="font-black text-gray-800 text-xs uppercase tracking-wider mb-4 flex items-center gap-2">
        <Plus size={16} className="text-emerald-600" /> Quick Callback Entry
      </h3>
      <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 items-end">
        <div>
          ...
          <input
            ...
            className="w-full p-2.5 border border-gray-200 rounded-xl text-xs outline-none bg-gray-50 focus:bg-white focus:border-emerald-500 transition-colors"
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-2.5 border border-gray-200 rounded-xl text-xs outline-none bg-gray-50 focus:bg-white focus:border-emerald-500 font-medium transition-colors"
          >
            {QUEUES.map((q) => (
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-2.5 border border-gray-200 rounded-xl text-xs outline-none bg-gray-50 focus:bg-white focus:border-emerald-500 font-bold transition-colors"
          >
            {PRIORITIES.map((p) => (
        ...
        <div>
          <button
            disabled={saving}
            type="submit"
            className="w-full h-[38px] bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-800 disabled:opacity-50 text-white font-bold rounded-xl text-xs transition-colors shadow-sm flex items-center justify-center"
          >
            {saving ? (
