    ...
    <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
      ...
      >
        <div className="flex items-center gap-3">
          {Icon && <Icon size={18} className="text-gray-500 group-hover:text-emerald-500 transition-colors" />}
          <h3 className="font-black text-gray-800 text-sm uppercase tracking-wide group-hover:text-emerald-600 transition-colors">
            {title}
          </h3>
          <span className="text-xs font-bold text-gray-500 bg-gray-100 px-2 py-0.5 rounded-md group-hover:bg-emerald-50 transition-colors">
            {calls.length}
          </span>
        </div>
        {expanded ? (
